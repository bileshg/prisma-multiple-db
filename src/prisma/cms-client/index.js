...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Workspace\\GitHub-Projects\\prisma-multiple-db\\src\\prisma\\cms-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Workspace\\GitHub-Projects\\prisma-multiple-db\\prisma\\cms-schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "CMS_DB_URL",
        "value": null
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"CMS_DB_URL\")\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/prisma/cms-client\"\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n  author    User    @relation(fields: [authorId], references: [id])\n  authorId  Int\n}\n",
  "inlineSchemaHash": "e7458fdf6aa35b90c31b3831ff40f803699c83ae18be5679e68d5198fd9a6713",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/prisma/cms-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/prisma/cms-client/schema.prisma")
